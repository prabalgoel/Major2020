...
content = driver.find_element_by_xpath('/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/span/a[1]/button')
content.click()
...
try:
    for i in range(1,number_of_post+1):
        ...
        try:
            ...
            print("not known")
        try:
            count=driver.find_element_by_xpath('/html/body/div[5]/div[2]/div/article/div[3]/section[2]/div/div')
            print(count)
            likes=(count.text)
        except:
            likes=0
            print(likes)
        try:
            date=driver.find_element_by_xpath('/html/body/div[5]/div[2]/div/article/div[3]/div[2]')
            print(date)
            date=(date.text)
        except:
            date="not known"
    ...
    df.to_csv('C:\\Users\\Prabal\\Desktop\\Major2020\\webScrapping\\about_post\\jlo.csv',index=False)        
    driver.close()
